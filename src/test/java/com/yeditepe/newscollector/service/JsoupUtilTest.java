...
import com.yeditepe.newscollector.crawler.DailySabahCrawler;
...
class JsoupUtilTest {
    ...
    void getElementByQuery() {
        JsoupUtil parser = new JsoupUtil();

        Elements elements =  parser.getElementByQuery("https://www.dailysabah.com/turkey/istanbul/istanbul-trial-pits-church-against-italian-royal-heirs",
                ".article_body");
    ...
    void getContent() {
        ...
        String content = parser.getContent("https://www.aa.com.tr/en/europe/belgium-virus-cases-near-50-000-as-deaths-drop/1826495",
                ".detay-icerik");
